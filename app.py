...
div[data-testid="stButton"] > button {
  ...
  transition: all 0.25s cubic-bezier(0.4, 0, 0.2, 1); /* 부드러운 애니메이션 */
  
  /* 기본 텍스트(가수명) 세팅: 작고 은은하게 */
  font-size: 0.95rem;
  font-weight: 500;
...
/* ✅ 선택된 버튼 - 은은한 보라/핑크 그라데이션으로 고급스럽게 하이라이트 */
